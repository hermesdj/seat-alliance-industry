        ...
        <div class="modal-content">
            <div class="modal-header bg-orange">
                <h4 class="modal-title">
                    ...
                    {{ trans('allianceindustry::ai-orders.modals.editPrices.title', ['code' => $order->order_id]) }}
                </h4>
            </div>
            <div class="modal-body">
                <p>{{ trans('allianceindustry::ai-orders.modals.editPrices.desc') }}</p>

                <form
                        id="formEditOrderPrices" method="POST"
                        action="{{ route('allianceindustry.updateOrderPrice', ['orderId' => $order->id]) }}"
                ...
                >
                    ...
                    @can('allianceindustry.change_price_provider')
                        <div class="form-group">
                            ...
                            @include("allianceindustry::utils.priceProviderSelector",["id"=>"priceprovider","name"=>"priceprovider","instance_id"=>$order->priceProvider])
