...
return [
    'create_order_title' => 'Créer un ordre',
    ...
    'split_items' => 'Séparer les items en différents ordres.',

    'reward_label' => 'Récompense en %',
    'reward_hint' => 'Le profit minimum est de :mpp',
    'add_profit_to_manual_prices_label' => 'Ajouter une récompense au prix manuel',
    ...
    'add_order_btn' => 'Ajouter un ordre',

    'invalid_order_label' => 'Ordre invalide',

    'close_order_btn' => 'Fermer cette ordre',
    ...
    // Marketplace
    'order_marketplace_title' => 'Ordre du marché',
    'open_orders_title' => 'Ouvrir les ordres',

    'close_all_completed_orders_btn' => 'Fermer tout les ordres complétés',

    'create_order_success' => 'Ajout d\'un nouvel ordre réussi !',
    'update_time_success' => 'Temps ajouté !',
    'update_price_success' => 'Prix mis à jour !',
    'close_order_success' => 'Fermeture de l\'ordre réussi !',
];